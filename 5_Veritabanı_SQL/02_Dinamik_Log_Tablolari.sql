...
alter table Sensor_Loglari alter column OrtamSicakligi decimal(5,2);
alter table Sensor_Loglari alter column OrtamNemi decimal(5,2);
alter table Sensor_Loglari alter column ToprakNemi decimal(5,2);
