...
bitki = test_json["bitki"] #burada optimal değerler var olan bitki hakkında:
anlik = test_json["anlikVeriler"] #anlık sensör ve kamera değerleri var:
zaman = test_json["zaman"] #bu saat gündüz gece için:
...
# python sözlüğünü JSON formatına çevird
